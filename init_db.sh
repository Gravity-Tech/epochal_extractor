...
docker exec -it postgres_db_transactions psql -U docker diesel_db -c "INTO poller_states(id,num) VALUES (14,${ftmblock}),(15,${ftmblock}),(16,${ftmblock});"
docker exec -it postgres_db_transactions psql -U docker diesel_db -c "INTO poller_states(id,num) VALUES (17,${bscblock}),(18,${bscblock}),(19,${bscblock}),(20,${bscblock});"
